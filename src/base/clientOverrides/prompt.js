...
prompt.affAbbrev = {
  addiction: { text: "add", fg: prompt.cureColors.ferrum.fg, bg: prompt.cureColors.ferrum.bg },
  aeon: { text: "ae", fg: "", bg: "" },
  ...
  clumsiness: { text: "cl", fg: prompt.cureColors.aurum.fg, bg: prompt.cureColors.aurum.bg },
  ...
  darkshade: { text: "dark", fg: prompt.cureColors.ferrum.fg, bg: prompt.cureColors.ferrum.bg },
  ...
  haemophilia: { text: "haem", fg: prompt.cureColors.ferrum.fg, bg: prompt.cureColors.ferrum.bg },
  hallucinations: { text: "hall", fg: "", bg: "" },
  hamstrung: { text: "hms", fg: "", bg: "" },
  healthleech: { text: "hthl", fg: prompt.cureColors.aurum.fg, bg: prompt.cureColors.aurum.bg },
  heartseed: { text: "heart", fg: "", bg: "" },
  hellsight: { text: "hell", fg: "", bg: "" },
  hypersomnia: { text: "hypers", fg: "", bg: "" },
  hypochondria: { text: "hypoch", fg: prompt.cureColors.aurum.fg, bg: prompt.cureColors.aurum.bg },
