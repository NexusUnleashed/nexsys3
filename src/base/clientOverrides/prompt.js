...
prompt.affAbbrev = {
  ...
  calcifiedskull: { text: "calSk", ...prompt.cureColors.restoration },
  calcifiedtorso: { text: "calTr", ...prompt.cureColors.restoration },
  claustrophobia: { text: "cla", ...prompt.cureColors.stannum },
  ...
  latched: { text: "lat", ...prompt.cureColors.health },
